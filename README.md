...
| CakePHP < 3.3.0 | CakePHP >= 3.3.0 | CakePHP >= 3.5.0 | CakePHP >= 3.10.* |
| --------------- | ---------------- | ---------------- | ----------------- |
| Wrench 1.X | Wrench 2.X | Wrench 3.5 | Wrench 3.10 |
| PHP >= 5.4.16 | PHP >= 5.5.9 | PHP >= 5.6.0 | PHP >= 7.4.0 |
| Uses CakePHP DispatcherFilter mecanism | Uses CakePHP Middleware Stack and PSR-7 Request / Response implementation | Uses CakePHP Middleware Stack and PSR-7 Request / Response implementation + no deprecation warning from CakePHP 3.6.X | No deprecation warning from CakePHP 3.10.X |
